...
function onLauncherConnect(slaveURL) {
    ...
    if (robotBrowser) {
        attester.logger.logWarn("The --robot-browser option is deprecated. Please consider using --launcher-config along with https://github.com/attester/robot-server instead.");

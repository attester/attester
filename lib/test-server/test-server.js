        ...
        campaigns: this.campaigns.map(function (campaign) {
            return {
                ...
                browsers: campaign.browsers.map(function (browser) {
                    return {
                        name: browser.name,
                        remainingTasks: browser.pendingTasks,
                        runningTasks: browser.pendingTasks - browser.tasksQueue.length
                    };
                })
            };
        })

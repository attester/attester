 ...
 * @param {Boolean} absolute If true, returns a URL starting from the root of the server and
 * including the campaign id, otherwise, returns a URL relative to the campaign.
 */

...
(function () {
    var window = this;
    var atjstestrunner = window.parent.atjstestrunner;
    ...
    var fatalError = function (message) {
        atjstestrunner.testError({
            error : {
                message : message
            }
        });
        atjstestrunner.taskFinished();
    };
    ...
    if (!atjstestrunner.globalErrors) {
    ...
    function onTestFailure (evt) {
        ...
        atjstestrunner.testError({
            ...
            error : {
                ...
                stack : atjstestrunner.stackTrace()
            }
        });
    }
    ...
    function onTestError (evt) {
        ...
        atjstestrunner.testError({
            ...
            error : {
                message : evt.msg,
                stack : atjstestrunner.stackTrace(evt.exception)
            }
        });
    }
    ...
    function cleanTaskEnd () {
        try {
            ...
            atjstestrunner.testError({
                error : {
                    ...
                    stack : atjstestrunner.stackTrace(e)
                }
            });
        }
        if (Aria.memCheckMode) {
            try {
                ...
                if (disposeInfos && disposeInfos.nbNotDisposed > 0) {
                    ...
                    atjstestrunner.testError({
                        error : {
                            message : 'The following ' + disposeInfos.nbNotDisposed
                                    + ' objects were not disposed correctly:\n' + msg.join('')
                        }
                    });
                }
            } catch (e) {
        ...
        atjstestrunner.coverage(window);
        atjstestrunner.taskFinished();
    }

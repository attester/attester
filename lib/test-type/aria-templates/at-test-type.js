...
var AriaTemplatesTests = function (campaign, inputConfig) {
    ...
    this.use(connect['static'](path.join(__dirname, 'client')));
};
...
AriaTemplatesTests.prototype.setBaseURL = function (baseURL) {
    BaseTestType.prototype.setBaseURL.call(this, baseURL);
    // We also want to change the ariaConfig and use this baseURL in the rootFolderPath
    this.ariaConfig.rootFolderPath = url.normalize(baseURL, this.ariaConfig.rootFolderPath) + "/";
};

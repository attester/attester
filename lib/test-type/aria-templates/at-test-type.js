...
var AriaTemplatesTests = function (campaign, testConfig) {
    ...
    if (ariaConfig.memCheckMode == null) {
        ariaConfig.memCheckMode = true;
    }
    if (ariaConfig.debug == null) {
        ariaConfig.debug = true;
    }
    this.ariaConfig = ariaConfig;
    this.bootstrap = testConfig.bootstrap || rootFolderPath + 'aria/bootstrap.js';
